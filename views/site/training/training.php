...
<div class="container">
    ...
    <div class="row">
        <div class="center-block">
            <a class="btn btn-success linkToDownload col-lg-2 wow fadeInRight" href="diplomado/Calendario Diplomado SGA Equipo AGA.pdf"
               target="_BLANK">
                Calendario
            </a>
            <a class="btn btn-success linkToDownload col-lg-2 wow fadeInRight"
            ...
            Modal::begin([
                ...
                'toggleButton' => [
                    'label' => 'Módulo II',
                    'class' => 'btn btn-success linkToDownload col-lg-2 wow fadeInRight'
                ],
            ]);
            ?>
            ...
            <a href="diplomado/Identificación Evaluación Aspectos Ambientales UADY.xls">Identificación Evaluación
                Aspectos
            ...
            Modal::begin([
                ...
                'toggleButton' => [
                    'label' => 'Módulo III',
                    'class' => 'btn btn-success linkToDownload col-lg-2 wow fadeInLeft'
                ],
            ]);
            ?>
            ...
            <a class="btn btn-success linkToDownload col-lg-2 wow fadeInLeft"
               href="diplomado/Modulo IV Control Operacional - Agua, Energía Eléctrica, Residuos.pdf" target="_BLANK">
                Módulo IV
            </a>
            <a class="btn btn-success linkToDownload col-lg-2 wow fadeInLeft" href="diplomado/Retro.pdf">
